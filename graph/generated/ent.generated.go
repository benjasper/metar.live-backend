...
func (ec *executionContext) marshalNAirport2ᚕᚖmetarᚗliveᚋentᚐAirportᚄ(ctx context.Context, sel ast.SelectionSet, v []*ent.Airport) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNAirport2ᚖmetarᚗliveᚋentᚐAirport(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
